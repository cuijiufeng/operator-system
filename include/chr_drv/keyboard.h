...
#define FLAG_BREAK		0x0080		//Break Code	(make code | 0x80 = break code)code)0000 0000 1000 0000
#define FLAG_EXT		0x0100		//所有的不可打印字符都加这个值，以此来标记			0000 0001 0000 0000
#define FLAG_SHIFT_L	0x0200		//左shift键											0000 0010 0000 0000
#define FLAG_SHIFT_R	0x0400		//右shift键											0000 0100 0000 0000
#define FLAG_CTRL_L		0x0800		//左ctrl键											0000 1000 0000 0000
#define FLAG_CTRL_R		0x1000		//右ctrl键 											0001 0000 0000 0000
#define FLAG_ALT_L		0x2000		//左alt键 											0010 0000 0000 0000
#define FLAG_ALT_R		0x4000		//右alt键 											0100 0000 0000 0000
#define FLAG_PAD		0x8000		//keys in num pad									1000 0000 0000 0000
...
EXTERN	t_bool		caps_lock;		//caps_lock键状态
EXTERN	t_bool		num_lock;		//num_lock键状态
EXTERN	t_bool		scroll_lock;	//scroll_lock键状态
